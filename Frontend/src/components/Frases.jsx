const Frases = () => {
  return (
    ...
    <div className="text-left px-0">
      ...
      Le Trip conecta con experiencias deportivas únicas a nivel global, ofreciendo aventuras únicas e inolvidables por disciplina, condiciones y destinos favoritos.
      </p>
    </div>
  </div>
  );
